...
<td  style="${window.location.hash === "#/Public" || "#/Traffic" ? "display: none;" : ""}"><button id="${conv[0]}" type="button" class="btn btn-sm btn-primary edit" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-pencil" id="${conv[0]}"></i></button></td>    
</tr>
`;
