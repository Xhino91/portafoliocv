...
export function Main() {
  ...
  <button  class="remolque btn btn-primary fw-bold  reg" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="${window.location.hash === "#/Public" || window.location.hash === "#/Traffic" || window.location.hash === "#/Inhouse" || window.location.hash === "#/InhouseHMO" || window.location.hash === "#/InhouseMX" || window.location.hash === "#/Tracking" ? "display: none;" : ""}">Agregar Remolque</button>
  <button  class="unidad btn btn-primary fw-bold  reg" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="${window.location.hash === "#/Public" || window.location.hash === "#/Traffic" || window.location.hash === "#/Inhouse" || window.location.hash === "#/InhouseHMO" || window.location.hash === "#/InhouseMX" || window.location.hash === "#/Tracking" ? "display: none;" : ""}">Agregar Unidad</button>
  </div>  
