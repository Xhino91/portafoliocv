...
export async function Router() {
 ...
 let user = localStorage.username;
  ...
  if (!user || user === "Public" || user === "Tracking" || user === "Traffic" || user === "TrafficH" || user === "InhouseTOL" || user === "InhouseHMO" || user === "InhouseMX" || user === "InhouseGTO") {
    
    if (hash === "#/Public/pruductivo") { 
